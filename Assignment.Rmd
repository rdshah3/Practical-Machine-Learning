...
After predicting results from the validation dataset, the random forest model, using 4-fold cross validation, has an accuracy of `r round(cf$overall["Accuracy"],4)`, giving us an out-of-sample error of `r round((1-cf$overall["Accuracy"])*100,4)`%
